...
@section('content')
    ...
    <section class="content-header">
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
                @can('create_client')
                    <button type="button" class="my-3 btn btn-primary" onclick="create()">Tambah Client</button>
                @endcan
        ...
        @include('components.modals.client.create')
        @include('components.modals.client.edit')
        <!-- /.card -->
